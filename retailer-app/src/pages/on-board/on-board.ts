...
export class OnBoardPage {
	...
	async onCreateTapped() {
		...
		await this.LoyalXProvider.get.TokenFactory.handleOnboard(formValues.retailSymbol, formValues.retailName, formValues.retailAmount, formValues.retailDecimal);
